...
namespace ShoppingCostPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20230408161937_authChanges")]
            ...
            modelBuilder.Entity("ShoppingCostPlanner.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 4, 8, 19, 19, 37, 499, DateTimeKind.Local).AddTicks(871),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 4, 8, 19, 19, 37, 499, DateTimeKind.Local).AddTicks(907),
