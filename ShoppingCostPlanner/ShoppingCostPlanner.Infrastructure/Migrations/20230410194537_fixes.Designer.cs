...
namespace ShoppingCostPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20230410194537_fixes")]
    partial class fixes
    {
            ...
            modelBuilder.Entity("ShoppingCostPlanner.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 4, 10, 22, 45, 36, 913, DateTimeKind.Local).AddTicks(8026),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 4, 10, 22, 45, 36, 913, DateTimeKind.Local).AddTicks(8059),
